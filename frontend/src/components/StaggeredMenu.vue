<template>
  <div class="w-full h-full sm-scope pointer-events-none">
    <div
      data-testid="staggered-menu-root"
    ...
    >
      ...
      <header
        class="top-0 left-0 z-20 absolute flex items-center bg-transparent p-[2em] w-full pointer-events-none staggered-menu-header"
      ...
      >
        <div class="flex items-center pointer-events-auto select-none sm-logo" aria-label="Logo">
          <img
            ...
            height="24"
          />
          <span v-else class="text-white text-sm tracking-[0.25em] uppercase">YOLOv8</span>
        </div>

        <div class="sm-toggle-center">
          <button
            ref="toggleBtnRef"
            data-testid="staggered-menu-toggle"
          ...
          >
            ...
            >
              <router-link
                ...
                :data-index="idx + 1"
                :data-testid="`staggered-menu-item-${idx}`"
