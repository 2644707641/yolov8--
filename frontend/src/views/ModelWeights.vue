  ...
  <div class="space-y-6">
    ...
    >
      <div>
        ...
        <h1
          data-testid="model-weights-title"
    ...
    <div class="flex-1 overflow-y-auto px-6 py-10 lg:px-12">
      <div class="mx-auto w-full max-w-6xl space-y-8">
        ...
        <div class="card">
          ...
          <div class="space-y-4">
            ...
            >
              ...
              <div v-if="!uploadingFile" class="space-y-4">
                <div
                  class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-primary-500/20 text-primary-300 transition-transform duration-300 group-hover:scale-110"
                >
                  <svg
                    class="h-8 w-8"
                    fill="none"
          ...
          <div
            v-if="uploadError"
            class="mt-4 rounded-xl border border-red-500/20 bg-red-500/10 p-4"
          >
        ...
        <div class="card">
          ...
          <!-- 加载中 -->
          <div
            v-if="loading && weights.length === 0"
            class="flex items-center justify-center py-12"
          >
            <div class="text-center">
              <div
                class="mx-auto h-12 w-12 animate-spin rounded-full border-4 border-primary-500/20 border-t-primary-400"
              ></div>
          ...
          <div
            ...
            class="rounded-2xl border border-white/10 bg-white/5 p-12 text-center"
          >
            <div
              class="mx-auto flex h-20 w-20 items-center justify-center rounded-2xl bg-slate-700/30 text-slate-400"
            >
              <svg
                class="h-10 w-10"
                fill="none"
                ...
                <div class="flex items-start justify-between gap-4">
                  <div class="flex-1 min-w-0">
                    ...
                    <p
                      ...
                      class="mt-2 text-sm text-slate-300/80"
                    >
                      {{ weight.description }}
                    </p>
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    >
                      <div
                        v-if="deleting === weight.id"
                        class="h-4 w-4 animate-spin rounded-full border-2 border-red-300/20 border-t-red-300"
                      ></div>
                      <span v-else>删除</span>
                    </button>
                    <span
          ...
          <div class="mt-6 space-y-4">
            <div>
              ...
              <p class="mt-1 text-xs text-slate-400">
                如果留空，将使用原文件名：{{ pendingWeightFile?.name }}
              </p>
            </div>
...
const loadWeights = async () => {
  ...
  try {
    ...
    const response = await fetch(
      `${import.meta.env.VITE_API_URL}/api/model-weights`,
      {
        headers: {
...
const activateWeight = async (weightId) => {
  ...
  try {
    ...
    const response = await fetch(
      `${import.meta.env.VITE_API_URL}/api/model-weights/${weightId}/activate`,
      {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`,
...
const deleteWeight = async (weightId) => {
  ...
  try {
    ...
    const response = await fetch(
      `${import.meta.env.VITE_API_URL}/api/model-weights/${weightId}`,
      {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
