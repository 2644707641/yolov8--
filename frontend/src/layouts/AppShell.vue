<template>
  ...
  >
    ...
    <div class="relative z-10 flex h-full overflow-hidden">
      ...
      >
          ...
          <div
            ...
            :class="
              isCollapsed
                ...
                : 'max-w-[240px] max-h-[72px] opacity-100 translate-x-0'
            "
          >
        ...
        >
          <p
            v-if="!isCollapsed"
            class="px-3 text-xs uppercase tracking-[0.4em] text-slate-400/70"
          >
            系统导航
          </p>
          <nav class="mt-3 space-y-1.5">
            ...
            >
              ...
              <span
                ...
                :class="[
                  isCollapsed ? 'flex-none max-w-0' : 'flex-1 max-w-[200px]',
                ]"
        ...
        >
          <div class="flex items-center justify-between px-6 py-3 lg:px-10">
            <div class="flex items-center gap-4">
              ...
              <div>
                <p
                  class="text-xs uppercase tracking-[0.35em] text-slate-400/80"
                >
                  系统控制台
                </p>
    ...
    <Transition name="fade">
      <div v-if="mobileNavOpen" class="fixed inset-0 z-50 flex lg:hidden">
        <div
        ...
        >
          <div
            ...
            class="flex shrink-0 items-center justify-between px-6 pb-4 pt-6"
          >
            <div>
